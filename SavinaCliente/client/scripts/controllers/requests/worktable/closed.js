(function (ng) {
  ...
  ng.module('App').controller('Requests:Worktable:Closed', [
    ...
    function ($scope, $http, $session, $q, $routeParams, $moment) {
      ...
      $scope.fetch = function () {
        ...
        $http.get('/api/requests/worktable/closed/' + $routeParams.type, {
          ...
          if (res.status > 0) {
            $session.flash('danger', "No pudimos obtener tus solicitudes cerradas");
          }
        }).then(function complete() {
