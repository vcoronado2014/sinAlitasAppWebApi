...
namespace WebApiSinAlitas.Controllers
{
    ...
    public class TareasProfesorController : ApiController
    {
        [AcceptVerbs("OPTIONS")]
        public void Options()
        { }
        ...
        public HttpResponseMessage Post(dynamic DynamicClass)
        {
            ...
            try
            {
                ...
                int nodId = 1;
                List<SinAlitas.Admin.Entidad.TareasEnvoltorio> tareasEnv = SinAlitas.Admin.Negocio.TareasProfesor.ObtenerTareasProfesorEnvoltorio(
