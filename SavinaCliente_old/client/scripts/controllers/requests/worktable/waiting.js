(function (ng) {
  ...
  ng.module('App').controller('Requests:Worktable:Waiting', [
    ...
    function ($scope, $http, $session, $q, $routeParams, $moment) {
      ...
      $scope.fetch = function () {
        ...
        $http.get('/api/requests/worktable/waiting/' + $routeParams.type, {
          ...
          if (res.status > 0) {
            $session.flash('danger', "No pudimos obtener las solicitudes en espera");
          }
        }).then(function complete() {
