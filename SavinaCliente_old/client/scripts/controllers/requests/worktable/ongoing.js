(function (ng) {
  ...
  ng.module('App').controller('Requests:Worktable:Ongoing', [
    ...
    function ($scope, $http, $session, $q, $routeParams, $moment) {
      ...
      $scope.fetch = function () {
        ...
        $http.get('/api/requests/worktable/ongoing/' + $routeParams.type, {
          ...
          if (res.status > 0) {
            $session.flash('danger', "No pudimos obtener tus solicitudes en proceso");
          }
        }).then(function complete() {
